...
data.aws_ami.amazon_linux: Read complete after 1s [id=ami-01eef5991d5b0b06c]
...
Terraform will perform the following actions:
  ...
  # aws_instance.web2["t4.micro"] will be created
  + resource "aws_instance" "web2" {
      + ami                                  = "ami-01eef5991d5b0b06c"
      + arn                                  = (known after apply)
      + associate_public_ip_address          = (known after apply)
...
│ 
│   on main.tf line 58, in resource "aws_instance" "web2":
│   58:     ignore_changes        = ["tags"]
│ 
